                                        ...
                                        role: 'admin' | 'profesor' | 'alumno'
                                          instituteName?: string
                                            logoUrl?: string | null
                                              ...
                                              export default function Sidebar({ role, instituteName, logoUrl, primaryColor }: SidebarProps) {
                                                  const pathname = usePathname()
                                                    const nav = role === 'admin' ? adminNav : role === 'profesor' ? teacherNav : studentNav
                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                          <p className="text-xs text-[#050F1F]/40 mt-0.5">Plataforma Educativa</p>
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        {/* Nav */}
                                                                                                                                                                                                                                                              <nav className="flex-1 p-3 space-y-0.5">
                                                                                                                                                                                                                                                                      {nav.map((item) => {
                                                                                                                                                                                                                                                                                const active = pathname === item.href || (item.href !== '/dashboard/admin' && item.href !== '/dashboard/teacher' && item.href !== '/dashboard/student' && pathname.startsWith(item.href))
                                                                                                                                                                                                                                                                                          return (
