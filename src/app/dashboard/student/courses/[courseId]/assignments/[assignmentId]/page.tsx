  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      <div className="flex items-center gap-2 mb-2 text-sm text-[#050F1F]/50">
        <Link href="/dashboard/student" className="hover:text-[#050F1F] transition-colors">← Mis cursos</Link>
        <span>/</span>
        <Link href={`/dashboard/student/courses/${courseId}/assignments`} className="hover:text-[#050F1F] transition-colors">Tareas</Link>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-black/5 shadow-sm p-6 mb-6">
        <div className="flex items-start justify-between gap-4 mb-3">
          <h2 className="text-lg font-semibold text-[#050F1F]">{a.title}</h2>
          {a.due_date && (
        ...
        {a.description && (
          <p className="text-sm text-[#050F1F]/70 whitespace-pre-wrap mb-4">{a.description}</p>
        )}
        <p className="text-xs text-[#050F1F]/40">Puntaje máximo: {a.max_score} pts</p>
      </div>
      ...
      {s && (
        <div className="bg-white rounded-2xl border border-black/5 shadow-sm p-5 mb-6">
          <div className="flex items-center justify-between mb-3">
            <p className="text-sm font-semibold text-[#050F1F]">Tu entrega</p>
      ...
      <div className="bg-white rounded-2xl border border-black/5 shadow-sm p-6">
        <h3 className="text-base font-semibold text-[#050F1F] mb-4">
