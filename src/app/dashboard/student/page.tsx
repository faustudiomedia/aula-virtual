  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-[#050F1F]/50 mt-1">Aquí tenés un resumen de tu progreso académico.</p>
      </div>

      {/* Stats */}
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          { label: 'Cursos inscriptos', value: items.length, color: '#1A56DB', bg: '#EFF6FF' },
          { label: 'Cursos completados', value: completed, color: '#059669', bg: '#ECFDF5' },
      ...
      {items.length === 0 ? (
        <div className="rounded-2xl border-2 border-dashed border-[#BAE6FD] p-12 text-center">
          ...
          <p className="text-[#050F1F]/50">Todavía no estás inscripto en ningún curso.</p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-1">
                  <h3 className="font-semibold text-[#050F1F] truncate">{enrollment.courses.title}</h3>
