...
async function createInstitute(formData: FormData) {
  'use server'
...
export default async function NewInstitutePage() {
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <h1 className="text-2xl font-bold text-[#050F1F] mt-3 mb-2">Crear nuevo instituto</h1>
      <p className="text-[#050F1F]/50 mb-8">Configurá la identidad del nuevo instituto.</p>

      <div className="bg-white rounded-2xl border border-black/5 shadow-sm p-6">
        <form action={createInstitute} className="space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="submit"
              className="flex-1 py-2.5 rounded-xl bg-[#1A56DB] text-white font-semibold text-sm hover:opacity-90 transition shadow-lg shadow-[#1A56DB]/20"
            >
              Crear instituto
            </button>
            <a
