    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl border border-black/5 shadow-sm p-6">
        ...
        <form action={formAction} className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-xs font-medium text-[var(--ag-text-muted)] mb-1">Nombre</label>
            <input
              name="name"
              required
          ...
          <div>
            <label className="block text-xs font-medium text-[var(--ag-text-muted)] mb-1">Inicio</label>
            <input
              name="start_date"
              type="date"
              required
          ...
          <div>
            <label className="block text-xs font-medium text-[var(--ag-text-muted)] mb-1">Fin</label>
            <input
              name="end_date"
              type="date"
              required
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-black/5">
                ...
                <th className="text-left px-6 py-3 text-xs font-semibold text-[var(--ag-text-muted)] uppercase tracking-wider">Estado</th>
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="text-xs text-[var(--ag-navy)] hover:underline"
                      >
