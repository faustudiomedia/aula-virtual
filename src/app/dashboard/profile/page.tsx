  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <div className="bg-[var(--ag-surface)] rounded-2xl border border-[var(--ag-border-light)] shadow-sm p-6">
        {/* Avatar preview */}
        <div className="flex items-center gap-4 mb-6 pb-6 border-b border-[var(--ag-border-light)]">
      ...
      <div className="mt-4 bg-[var(--ag-surface)] rounded-2xl border border-[var(--ag-border-light)] shadow-sm p-6">
        ...
        <Link
          ...
          className="inline-block px-4 py-2 rounded-xl border border-[var(--ag-border)] text-sm text-[var(--ag-text)]/70 hover:bg-[var(--ag-surface-alt)] transition font-medium"
        >
          Cambiar contraseña →
        </Link>
      </div>
