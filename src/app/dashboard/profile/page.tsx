  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <span className="text-sm font-medium text-[#050F1F]">Mi perfil</span>
      </div>

      <h1 className="text-2xl font-bold text-[#050F1F] mb-1">Mi perfil</h1>
      <p className="text-[#050F1F]/50 mb-8">Actualizá tu información personal.</p>

      <div className="bg-white rounded-2xl border border-black/5 shadow-sm p-6">
        {/* Avatar preview */}
        <div className="flex items-center gap-4 mb-6 pb-6 border-b border-black/5">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#1A56DB] to-[#38BDF8] flex items-center justify-center text-white text-2xl font-bold overflow-hidden flex-shrink-0">
            {profile.avatar_url ? (
      ...
      <div className="mt-4 bg-white rounded-2xl border border-black/5 shadow-sm p-6">
        <h2 className="text-sm font-semibold text-[#050F1F] mb-1">Contraseña</h2>
        <p className="text-sm text-[#050F1F]/50 mb-3">
          Para cambiar tu contraseña, solicitá un enlace de restablecimiento.
        </p>
        <Link
          href="/forgot-password"
          className="inline-block px-4 py-2 rounded-xl border border-black/10 text-sm text-[#050F1F]/70 hover:bg-black/5 transition font-medium"
        >
          Cambiar contraseña →
        </Link>
      </div>
