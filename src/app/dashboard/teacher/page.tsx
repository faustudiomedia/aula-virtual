  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link
          ...
          className="px-4 py-2 rounded-xl bg-[#1A56DB] text-white text-sm font-semibold
                     hover:bg-[#1A56DB]/90 transition-colors shadow-lg shadow-[#1A56DB]/20"
        >
          + Nuevo curso
        </Link>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          { label: 'Cursos activos', value: courseList.filter((c) => c.published).length, color: '#1A56DB', bg: '#EFF6FF' },
          { label: 'Cursos totales', value: courseList.length, color: '#7C3AED', bg: '#F5F3FF' },
