  ...
  return (
    <div className="flex gap-2 flex-shrink-0">
      <button
        ...
        className="text-xs px-3 py-1.5 rounded-lg border border-[var(--ag-border)] text-[var(--ag-text-muted)] hover:bg-amber-50 hover:text-amber-600 hover:border-amber-300/50 transition-all disabled:opacity-50"
      >
      ...
      <button
        ...
        className="text-xs px-3 py-1.5 rounded-lg border border-[var(--ag-border)] text-[var(--ag-text-muted)] hover:bg-red-50 hover:text-red-600 hover:border-red-300/50 transition-all disabled:opacity-50"
      >
